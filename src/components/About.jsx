          ...
          >
            <div className="rounded-2xl p-8">
              ...
              <p className="text-gray-300 mb-6">
                ...
                experience creating digital solution for businesses around the
                world.My journey started with basic HTML/CSS websites and has
                evolved into building complex web application with modern
                frameworks.{" "}
              </p>
              <p className="text-gray-300 mb-12">
                When I'm not coding,you can find me exploring new technologies,
                contributing to open-source projects,or sharing my knowledge
                through tech bogs and tutorials. I believe in continuous
